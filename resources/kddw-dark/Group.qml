/*
  Dark-themed Group (frame around docked tabs) for KDDockWidgets.
  Based on the original Group.qml with dark colors.
*/
...
Rectangle {
    ...
    Loader {
        ...
        anchors {
            ...
            // 1 pixel gap so we don't overlap with outer frame
            leftMargin: 1
            rightMargin: 1
        }
    }
