	...
	Rectangle {
		...
		RowLayout {
			...
			ColumnLayout {
				...
				GridLayout {
					...
					TurnController {
						...
						Layout.minimumWidth: 80
						Layout.minimumHeight: 80
						yawspeed: panelBackground.live ? droneManager.yawspeed : yawspeedSlider.value
						yacc: panelBackground.live ? droneManager.yacc : yaccSlider.value
					}
					...
					BatteryIndicator {
						...
						Layout.minimumWidth: 80
						Layout.minimumHeight: 80
						batteryPercent: panelBackground.live ? droneManager.batteryPercent : 100
					}
				}
				...
				Rectangle {
					...
					GridLayout {
						...
						Label {
							text: "Yawspeed: " + (panelBackground.live ? droneManager.yawspeed.toFixed(2) : yawspeedSlider.value.toFixed(2)) + " r/s"
							font.pixelSize: 15
							font.bold: true
							color: panelBackground.live ? "#27ae60" : "#2c3e50"
							Layout.preferredWidth: 130
						...
						Label {
							text: "Yacc: " + (panelBackground.live ? droneManager.yacc.toFixed(2) : yaccSlider.value.toFixed(2)) + " mg"
							font.pixelSize: 15
							font.bold: true
							color: panelBackground.live ? "#27ae60" : "#2c3e50"
							Layout.preferredWidth: 130
			...
			AltitudeTape {
				...
				Layout.minimumWidth: 80
				altitude: panelBackground.live ? droneManager.altitude : 0
			}
		}
	}
}
