...
class CameraManager : public QObject {
   ...
   public:
	...
	Q_INVOKABLE void setDetectionConfidence(int id, double confidence);

	[[nodiscard]] Q_INVOKABLE QString streamStatus(int id) const;
	[[nodiscard]] Q_INVOKABLE bool streamConnected(int id) const;
	[[nodiscard]] Q_INVOKABLE bool detectionEnabled(int id) const;
	[[nodiscard]] Q_INVOKABLE double detectionConfidence(int id) const;
   ...
   signals:
	...
	void detectionEnabledChanged(int id, bool enabled);
	void detectionConfidenceChanged(int id, double confidence);
